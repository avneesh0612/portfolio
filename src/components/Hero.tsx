...
export const Hero: FC = () => {
  return (
    <section
      className="flex w-full flex-col-reverse md:flex-row items-center justify-between pt-10 md:pt-20 gap-4 min-h-screen px-4 md:px-0"
      id="home"
    >
      <RoughNotationGroup show>
        <p className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed text-gray-200 md:flex-2/3">
          Hey, I&apos;m{" "}
          <RoughNotation type="highlight" color="#F59E0B" order="1">
            Avneesh Agarwal
          </RoughNotation>
          ...
          <RoughNotation type="underline" color="#10B981" order="2">
            CTO at Orcas
          </RoughNotation>
      ...
      <Image
        ...
        width={300}
        height={300}
        className="w-48 md:w-[300px] h-48 md:h-[300px] mb-8 md:mb-0 p-4 md:p-10 md:m-10 border-2 border-gray-900 shadow-lg shadow-gray-900/50 hover:shadow-gray-900/70 transition-all duration-200 mt-10 md:mt-0"
        priority
      />
    </section>
  );
